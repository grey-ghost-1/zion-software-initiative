...
describe("Zion landing shell", () => {
  ...
  it("discloses the Zion categories and safety boundaries", () => {
    ...
    expect(screen.getByText(/Harbor and Haven flagship demonstrations/i)).toBeVisible();
    ...
    expect(screen.getByText(/two first-class Zion project pages/i)).toBeVisible();
