...
describe("Projects page", () => {
  ...
  it("surfaces the two Zion project routes before the supporting foundation cards", () => {
    render(<ProjectsPage />);
    ...
    expect(screen.getByText("Two first-class project pages, one shared foundation")).toBeVisible();
    ...
    expect(screen.getAllByText("Impact case study").length).toBe(2);
